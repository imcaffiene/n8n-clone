...
export const EntityPagination = ({ onPageChange, page, totalPage, disabled }: EntityPaginationProps) => {
...
export function EntityList<T>({ getKey, items, renderItem, className, emptyView }: EntityListProps<T>) {
